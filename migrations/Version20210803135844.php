 ...
 */
final class Version20210803135844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD COLUMN images VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__articles AS SELECT id, auteur, contenu, created_at FROM articles');
        ...
        $this->addSql('INSERT INTO articles (id, auteur, contenu, created_at) SELECT id, auteur, contenu, created_at FROM __temp__articles');
